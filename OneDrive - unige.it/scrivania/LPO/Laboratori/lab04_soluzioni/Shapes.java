...
public class Shapes {
	...
	/*
	 * restituisce la prima figura maggiore o uguale alle altre in shapes rispetto
	 * al comparator comp null se shapes e` vuoto requires shapes != null && comp !=
	 * null
	 */
	...
	/*
	 * trasla tutte le figure lungo il vettore (dx,dy) requires shapes != null
	 */
	...
	/*
	 * restituisce l'area totale di tutte le figure in shapes requires shapes !=
	 * null
	 */
